...
def generate_launch_description():
    ...
    # Initialize UR Description and Semantic Configuration arguments
    ...
    ld.add_action(
        DeclareLaunchArgument(
            "start_rviz",
            default_value="true",
            description="Use Rviz2 to visualize the robot and plan trajectories."
        )
    )
    ...
    # Add MoveIt movegroup interface node 
    ...
    ld.add_action(mg_interface)

    # add Rviz to visualizzation 
    rviz_config_file = PathJoinSubstitution(
        [FindPackageShare("the_mtc_planner"), "rviz", "mg_int_view.rviz"]
    )
